...
DROP TABLE IF EXISTS afluencia CASCADE;
DROP TABLE IF EXISTS estacion_linea CASCADE;
DROP TABLE IF EXISTS linea CASCADE;
DROP TABLE IF EXISTS estacion_info CASCADE;
DROP TABLE IF EXISTS fecha_metro CASCADE;
DROP TABLE IF EXISTS tipo_pago CASCADE;
DROP TABLE IF EXISTS nombre_linea CASCADE; ;
